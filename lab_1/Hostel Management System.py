...
def main() -> None:
    ...
    def add_stud() -> None:
        ...
        dob = Label(
            base, text="DOB", font=("Arial 15 bold"), bg="silver", fg="black"
        )
        ...
        message = Label(
            base,
            text="(Contact No. will be your Hostel ID)",
            font=("Arial 10 bold"),
            bg="silver",
            fg="black",
        )
        ...
        email = Label(
            base, text="Email", font=("Arial 15 bold"), bg="silver", fg="black"
        )
    ...
    def add_room() -> None:
        ...
        def add() -> None:
            ...
            for i in all_lines:
                ...
                one_line = temp.split(',')
                if one_line[0] == r:
                    room_added_label = Label(
                        base,
                        text="Room Is Already Addded....!",
                        font=("Arial 25 bold"),
                        bg="silver",
                        fg="black",
                    )
    ...
    def in_out_time() -> None:
        ...
        def search_outtime() -> None:
            ...
            count = 1
            for oneline in fdata_ls:
                if oneline.startswith(s_id + ",") and oneline.__contains__(
                    ",OUTTIME,"
                ):
                    # write date
                    count = 2
                    ...
                    tv.set(y[2] + "     " + y[3])
                    ot = Entry(
                        base, width=20, textvariable=tv, font=("Arial 20 bold")
                    )
        ...
        def save2() -> None:
            ...
            if count == 1:
                    ...
                    base,
                    text="Please Give Correct Information",
                    font=("Arial 20 bold"),
                    bg="silver",
                    fg="black",
                )
    ...
    def visitor() -> None:
        ...
        h1.place(x=320, y=105)
        v_name = Label(
            base, text="Name", font=("Arial 20 bold"), bg="silver", fg="black"
        )
        ...
        def search() -> None:
            ...
            reset_btn = Button(
                base, text="Reset", font=("Arial 20 bold"), command=reset
            )
        ...
        ser_btn = Button(
            base, text="Search", font=("Arial 20 bold"), command=search
        )
    ...
    def view_info() -> None:
        ...
        stud_info = Button(
            base,
            text="Information Of All Students",
            wraplength=180,
            justify=CENTER,
            font=("Arial 20 bold"),
            padx=50,
    ...
    def leave_application() -> None:
        ...
        n_label = Label(
            base, text="Name", bg="silver", font=("Arial 20 bold"), fg="black"
        )
...
username = Label(
    base, text="Username", font=("Arial 25 bold"), bg="silver", fg="black"
)
...
password = Label(
    base, text="Password", font=("Arial 25 bold"), bg="silver", fg="black"
)
